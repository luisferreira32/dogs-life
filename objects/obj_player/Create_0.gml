...
POOP_METER_FILL_RATIO_MS = 0.0005; // poop meter percentage growth on milli seconds dt
POOP_METER_MIN = 10; // can only poop if it has filled at least this amount
POOP_METER_WARN = 80; // will only show poop meter if it has filled at least this amount
